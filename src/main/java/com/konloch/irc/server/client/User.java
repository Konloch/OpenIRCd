package com.konloch.irc.server.client;

import com.konloch.irc.OpenIRCd;
import com.konloch.irc.protocol.encoder.IRCProtocolEncoder;
import com.konloch.irc.server.channel.Channel;
import com.konloch.socket.SocketClient;

import static com.konloch.irc.protocol.encoder.messages.IRCOpcodes.PING;
...
public class User
{
	 ...
	 */
	public User(OpenIRCd irc, SocketClient client)
	{
		this.irc = irc;
		this.client = client;
