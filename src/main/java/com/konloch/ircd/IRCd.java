...
import com.konloch.ircd.server.client.UserBuffer;
import com.konloch.ircd.server.config.IRCdConfig;
import com.konloch.ircd.extension.plugins.NickServ;
import com.konloch.ircd.extension.plugins.ResourceLimiter;
import com.konloch.ircd.protocol.decoder.IRCProtocolDecoder;
import com.konloch.ircd.extension.events.EventManager;
...
public class IRCd
{
	...
	public static void main(String[] args) throws IOException, URISyntaxException
	{
		...
		IRCd ircd = new IRCd(new File("./config.ini"));
	...
	public IRCd(File configFile) throws IOException, URISyntaxException
	{
